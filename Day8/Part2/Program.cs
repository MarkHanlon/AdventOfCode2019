...
namespace Day7
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            timer.Stop();
            Console.WriteLine($"Done with picture output, execution in {timer.ElapsedMilliseconds}ms");

        }

        private static int FindColour(int[,,] image, int x, int y)
        {
            for(int l = 0; l < 100; l++)
            {
                if (image[l,x,y] != 2)
